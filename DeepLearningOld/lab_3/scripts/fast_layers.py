...
try:
    ...
    def col2im_cython(cols, N, C, H, W, field_height, field_width, padding, stride):
        return col2im_indices(cols, (N, C, H, W), field_height, field_width, padding, stride)

    def col2im_6d_cython(cols, N, C, H, W, HH, WW, pad, stride):
        cols_reshaped = cols.reshape(C * HH * WW, -1)
        return col2im_indices(cols_reshaped, (N, C, H, W), HH, WW, pad, stride)
